...
You may ONLY propose those four keys (entryWindowEnd is "HH:MM" ET ≤ "15:00"; minSignals 2-4; deltaLow/deltaHigh between 0.30 and 0.70). NEVER propose changes to sizing, stops, the $400 cap, the VIX band, or anything else — those are fixed. If you have no confident change, output PROPOSAL_JSON: {"change":{},"rationale":"insufficient evidence","confidence":"low"}.`;
